...
//        GraphLoader.loadRoutes("data/airports/routesUA.dat", graphFromFile);
...
//		System.out.println("****");
		...
		Graph graphList = new GraphAdjList();
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", graphList);
		System.out.println(graphList.getDistance2(0));
		System.out.println("***");
		System.out.println("Test AdjMatrix:");
		Graph graphMatrix = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", graphMatrix);
		System.out.println(graphMatrix.getDistance2(0));
		System.out.println("***");
    ...
    public List<Integer> degreeSequence() {
        List<Integer> degreeSequence = new ArrayList<>(numVertices);
